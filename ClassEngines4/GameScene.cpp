...
bool GameScene::OnCreate()
{
	...
	CoreEngine::GetInstance()->GetCamera()->AddLightSource(new LightSource(glm::vec3(0.0f, 0.0f, 2.0f), 0.1f, 0.5f, 0.5f, glm::vec3(1.0f, 0.0f, 0.0f)));
	...
	model->AddMesh(new Mesh(vertexList, ShaderHandler::GetInstance()->GetShader("basicShader"), TextureHandler::GetInstance()->GetTexture("CheckerboardTexture")));
